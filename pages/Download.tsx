...
const Download: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
      <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6">Take Free Voice <span className="text-indigo-500">Everywhere</span></h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto mb-20">
        ...
        <div className="glass p-12 rounded-[48px] border border-white/10 relative group overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-600/20 blur-3xl -mr-16 -mt-16 group-hover:bg-indigo-600/40 transition-all"></div>
          <Monitor className="w-16 h-16 text-indigo-500 mx-auto mb-8" />
          <h2 className="text-3xl font-bold text-white mb-4">Desktop App</h2>
          <p className="text-slate-400 mb-10">System-wide mic interception for Windows & macOS. Perfect for Discord and games.</p>
          
          <div className="space-y-4">
            <button className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl flex items-center justify-center space-x-2 transition-all">
        ...
        {/* Mobile */}
        <div className="glass p-12 rounded-[48px] border border-white/10 relative group overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-purple-600/20 blur-3xl -mr-16 -mt-16 group-hover:bg-purple-600/40 transition-all"></div>
          <Smartphone className="w-16 h-16 text-purple-500 mx-auto mb-8" />
          <h2 className="text-3xl font-bold text-white mb-4">Mobile App</h2>
          <p className="text-slate-400 mb-10">Real-time voice modulation for calls and voice chats. Android first support.</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-center space-x-2 text-xs text-slate-500">
              <span>iOS coming soon in 2024</span>
            </div>
          </div>
        </div>
      </div>
